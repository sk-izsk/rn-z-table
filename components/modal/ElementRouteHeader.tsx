...
export const ElementRouteHeader = () => {
  ...
  return (
    <View className="mb-4 flex-row items-center justify-between rounded-[26px] border border-[#d7e4ed] bg-panel/95 px-4 py-3 shadow-panel dark:border-line-dark dark:bg-panel-dark">
      <View className="flex-row items-center gap-3">
        ...
        <View>
          <Text className="text-[27px] font-black tracking-[-0.5px] text-ink dark:text-ink-dark">
            {brand.title}
          </Text>
